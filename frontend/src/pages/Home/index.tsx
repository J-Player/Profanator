...
const Home = () => {
	return (
		<Section>
			...
			<p>O guia definitivo para jogadores como você!</p>
			...
			<div>
				...
				<p><strong>Agora você saberá exatamente a quantidade necessária de materiais para criar seus itens!</strong> 🤗</p>
			</div>
			...
			<div>
				...
				<p>
					Em <Link to={"/economy"}>Economy</Link> você encontrará diversos dados históricos de todos os tipos de <strong>itens que são comercializados aqui</strong>.
				</p>
			</div>
		</Section>
	)
